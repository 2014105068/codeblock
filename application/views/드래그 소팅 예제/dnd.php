                                        ...
                                        <div class="tab-base">
                                            ...
                                            <div class="tab-content">
                                                <div id="demo-lft-tab-1" class="tab-pane fade active in">
                                                    <!-- 화살표 넣음 -->
                                                     <img id="test_drag1" src="assets/Arrow.png"width="30" height="30" alt="화살표">
...
<!--                                                        <h4 class="text-thin">변수변수</h4>     -->
                             ...
                             <div class="col-lg-6">
                                <div class="tab-base" id="appscrolldiv3">
...
-->
        ...
        <script>
//            s #test_drag1.draggable, #appscrolldiv3.droppable
		var ypos = 0;
        $( function() {
            $( "#test_drag1" ).draggable({
					//connectToSortable:"#",
                    stack: "#test_drag1",
                    revert: "invalid",
                    cursor: "grabbing",
...
//                    containment: "parent"
			...
			$( "#appscrolldiv3" ).droppable({
				drop: function(event, ui){
					var newitem = $(ui.draggable).clone(true).detach().css({
                        position: 'relative',
                        top: 'auto',
                        left: 'auto'
                    }).appendTo(this);
                    $(".col-lg-3 appscrolldiv").text("초록색 화살표 : ex) for i in 10");
                },
