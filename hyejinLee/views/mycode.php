...
<html lang="en">
    <head>
        ...
        <title> Typography | SensationApp - Responsive admin template.</title>
    ...
    <body>
            ...
            <div class="boxed">
                ...
                <section id="content-container">
                    ...
                    <header class="pageheader">
                        <h3><i class="fa fa-home"></i> Mycode </h3>
                        <div class="breadcrumb-wrapper">
                            <span class="label">You are here:</span>
                            <ol class="breadcrumb">
                                <li> <a href="index.html"> Home </a> </li>
                                <li class="active"> Mycode </li>
                            </ol>
                        </div>
                    </header>
                    <!--Page content-->
                            ...
                            <div class="col-md-6 eq-box-md grid">
                                <div class="panel a">
                                    <div class="panel-heading">
                                        ...
                                        <h3 class="panel-title">code_1</h3>
                                    </div>
                                    <div class="panel-body">
                                      ...
                                      <!--  <h3>h1. Bootstrap heading</h3>
                                        ...
                                        <?php
                                         $result ="";
                                         $lines=@file("input2.txt") or $result = "파일을 읽을 수 없습니다";
                                         if ($lines !=null)
                                         {
                                ...
                                <div class="panel b">
                                    <div class="panel-heading">
                                        ...
                                        <h3 class="panel-title">code_3</h3>
                                    </div>
                                    <div class="panel-body">
                                        
                                        <?php
                                         $f=@fopen("input.txt",'r') or exit("Break");
                            ...
                            <div class="col-md-6 eq-box-md grid">
                                <div class="panel c">
                                    <div class="panel-heading">
                                        ...
                                        <h3 class="panel-title">code_2</h3>
                                    </div>
                                    <div class="panel-body">
                                       <!-- <h1>h1. Bootstrap heading <small>Subheading</small></h1>
                                        <h2>h2. Bootstrap heading <small>Subheading</small></h2>
                                        <h3>h1. Bootstrap heading <small>Subheading</small></h3>
                                        <h4>h4. Bootstrap heading <small>Subheading</small></h4>
                                        <h5>h5. Bootstrap heading <small>Subheading</small></h5>
                                        <h6>h6. Bootstrap heading <small>Subheading</small></h6>-->
                                      
                                          
                                      <?php
                                         $result ="";
                                         $lines=@file("input.txt") or $result = "파일을 읽을 수 없습니다";
                                         if ($lines !=null)
                                         {
                                ...
                                <div class="nano-content">
                                    <ul id="mainnav-menu" class="list-group">
                                        ...
                                        <li>
                                            ...
                                            <!--Submenu-->
                                            <ul class="collapse">
                                                <li><a href="/c"><i class="fa fa-caret-right"></i> C block coding </a></li>
                                        ...
                                        <li class="list-divider"></li>
                                        <!--Category name-->
                                        <li class="list-header">My code</li>
                                        <!--Menu list item-->
                                        <li>
                                            <a href="#a">
                                        ...
                                        <li>
                                            ...
                                            <span class="menu-title">code_3</span>
        ...
        <script src="js/demo/ui-typography.js"></script>
    </body>
</html>